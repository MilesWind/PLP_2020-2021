...
class GAN(object):
    ...
    def discriminator_model(self):
        if self.DM:
            return self.DM;
        optimizer = RMSprop(learning_rate=0.004, clipvalue=1.0, decay=0.001);
        self.DM = Sequential();
    ...
    def adversarial_model(self):
        if self.AM:
            return self.AM;
        optimizer = RMSprop(learning_rate=0.002, clipvalue=1.0, decay=0.0005);
        self.AM = Sequential();
...
class Apple_GAN:
    ...
    def Train(self, train_steps=999999999, data_width=100, save_interval=10):
        ...
        for i in range(train_steps):
            ...
            e.elapsed_time();
            f.Generate('output/output-%s.jpg' % str(i+1));
